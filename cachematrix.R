...
## If so, the before calculated value is returned. If not, it computes the inverse, then stores by calling the setinvers() function and finally returns the inverse.
