...
## If so, the before calculated value is returned. If not, it computes the inverse, then stores it by calling the setinvers() (defined above) function and finally returns the inverse.
